---
title: 객체지향의 5대원칙 - SOLID (SPR, OCP, LSP, ISP, DIP)
author: sunghoon
...
# 객체지향의 5대원칙 : SOLID (SPR, OCP, LSP, ISP, DIP)
---
...
class Youtube implements playerLogic{  
	@Override  
	public void play(){
		  System.out.println("play youtube"); // 유튜브 재생   
	}  
...
class Netflix implements playerLogic{  
	@Override  
	public void play(){
...
```java  
class Player{
	private playerLogic platform;  

	public void setPlatform(playerLogic platform) {
...
public class Client {  
	public static void main(String[] args) {  
		player player = new Player();  
		player.setPlatform(new Youtube());  //원하는 플랫폼 선택  
		player.setPlatform(new Netflix());          
		player.play();	  
	}  
}  
```
